...
- **Endpoint**: `GET https://app-bug120s0lon5-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart`
...
async function callWebSearch(
  ...
  const response = await fetch(
    `https://app-bug120s0lon5-api-VaOwP8E7dKEa.gateway.appmedo.com/search/FgEFxazBTfRUumJx/smart?${params.toString()}`,
    {
      method: "GET",
      headers: {
