...
**Endpoint:** `GET https://app-bug120s0lon5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-bug120s0lon5-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
